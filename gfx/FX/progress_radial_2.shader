...
[[
    float4 main( VS_OUTPUT v ) : PDX_COLOR
    {
        ...
        vAngle = (vAngle + 1.57079632f) % (3.14159265f * 2.f); 
        vAngle = vAngle * 2.f;
        ...
        float vScaledAngle = vAngle * RotationScale;
        
        
        float vTarget = CurrentState * (3.14159265f * 2.f) * RotationScale;
        
       
        float vLerp = saturate( ( vScaledAngle - vTarget ) * 20.0f );
